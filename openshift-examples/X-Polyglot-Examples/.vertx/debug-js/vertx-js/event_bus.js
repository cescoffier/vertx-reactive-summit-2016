...
var EventBus = function(j_val) {
  ...
  this.send = function() {
    ...
    if (__args.length === 2 && typeof __args[0] === 'string' && true) {
      ...
      return that;
    }  else if (__args.length === 3 && typeof __args[0] === 'string' && true && (typeof __args[2] === 'object' && __args[2] != null)) {
      ...
      return that;
    }  else if (__args.length === 4 && typeof __args[0] === 'string' && true && (typeof __args[2] === 'object' && __args[2] != null) && typeof __args[3] === 'function') {
